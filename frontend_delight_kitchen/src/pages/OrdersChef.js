      ...
      <div className="title">
        ...
        <div className="mainelementordch">
          ...
          <div className="subelementordch">
            <table id="ordchtableid" style={{ textAlign: "center" }} className="table table-bordered table-hover mb-0">
              <thead>
              ...
              <tbody>
                {orderData.map((odata) => (
                  <tr key={odata.orderId}>
                    ...
                    <td>
                      <button onClick={() => getOrderItem(odata.orderId)} data-bs-toggle="modal" data-bs-target="#addModal" className="btn btn-info btn-md">View</button>
                    </td>
                  </tr>
                ))}
              </tbody>
